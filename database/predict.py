...
DB_PREDICT_PATH = os.getenv("DB_PREDICT_PATH", "future_prices.db")
FUEL_TYPES = os.getenv("FUEL_TYPES", "DL,E10,P95,P98,U91,PDL,LPG").split(",")
SEQ_LENGTH = int(os.getenv("SEQ_LENGTH", 180))
BATCH_SIZE = int(os.getenv("BATCH_SIZE", 32))
EPOCHS = int(os.getenv("EPOCHS", 100))
PATIENCE = int(os.getenv("PATIENCE", 20))
MODEL_PATH = os.getenv("MODEL_PATH", "future_avg_price_model.pth")
